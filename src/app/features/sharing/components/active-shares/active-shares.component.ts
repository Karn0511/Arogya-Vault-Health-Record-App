  ...
  template: `
    <div class="max-w-7xl mx-auto p-6">
      ...
      <div class="mb-6 border-b border-gray-200 dark:border-gray-700">
        <nav class="-mb-px flex space-x-8">
          <button *ngFor="let tab of tabs"
            ...
            [ngClass]="selectedTab === tab.status ? '' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'">
            {{ tab.label }}
            <span *ngIf="tab.count !== undefined" class="ml-2 px-2 py-1 text-xs rounded-full"
              [ngClass]="selectedTab === tab.status ? 'bg-primary-100 text-primary-600 dark:bg-primary-900 dark:text-primary-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'">
              {{ tab.count }}
            </span>
          </button>
        </nav>
      ...
      <div *ngIf="isLoading" class="space-y-4">
        <div *ngFor="let i of [1,2,3]" class="bg-white dark:bg-gray-800 rounded-lg p-6 animate-pulse">
      ...
      <!-- Shares List -->
      <div *ngIf="!isLoading && shares.length > 0" class="space-y-4">
        <div *ngFor="let share of shares" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p *ngIf="share.sharedWithPhone" class="text-sm text-gray-600 dark:text-gray-400">{{ share.sharedWithPhone }}</p>
                </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <div class="mt-1 flex flex-wrap gap-1">
                    <span *ngFor="let scope of share.scopes" class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded text-xs">
                      {{ formatScope(scope) }}
                    </span>
                  </div>
                </div>
              ...
              <div class="flex items-center gap-6 text-sm">
                ...
                <div *ngIf="share.lastAccessedAt" class="flex items-center gap-2">
                  <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Purpose -->
              <div *ngIf="share.purpose" class="mt-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            ...
            <div class="ml-6 flex flex-col gap-2">
              <ng-container *ngIf="share.status === 'ACTIVE'">
                <button
              ...
              <div *ngIf="share.status === 'REVOKED'" class="text-xs text-gray-500 dark:text-gray-400">
          ...
          <div *ngIf="expandedShareId === share.id && accessLogs" class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Access History</h4>
            <div class="space-y-2 max-h-60 overflow-y-auto">
              <div *ngFor="let log of accessLogs" class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg text-sm">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p *ngIf="log.recordType" class="text-xs text-gray-600 dark:text-gray-400">{{ log.recordType }}</p>
                  </div>
                </div>
                <div class="text-right text-gray-600 dark:text-gray-400">
                  <p>{{ log.timestamp | date:'short' }}</p>
                  <p *ngIf="log.ipAddress" class="text-xs">{{ log.ipAddress }}</p>
                </div>
              </div>
              <p *ngIf="accessLogs.length === 0" class="text-center text-gray-500 dark:text-gray-400 py-4">No access yet</p>
            </div>
          </div>
      ...
      <!-- Empty State -->
      <div *ngIf="!isLoading && shares.length === 0" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-12 text-center">
        ...
        <button *ngIf="selectedTab === 'ACTIVE'"
          (click)="router.navigate(['/patient/sharing/create'])"
      ...
      <!-- QR Code Modal -->
      <div *ngIf="showingQR && selectedShare" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" (click)="showingQR = false">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4" (click)="$event.stopPropagation()">
          ...
          <img *ngIf="selectedShare.qrCodeDataUrl" [src]="selectedShare.qrCodeDataUrl" alt="QR Code" class="w-full mb-4 border border-gray-300 dark:border-gray-700 rounded-lg">
          <div *ngIf="selectedShare.accessCode" class="text-center mb-4">
