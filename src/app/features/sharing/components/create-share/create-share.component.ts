      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button *ngFor="let preset of sharePresets"
              type="button"
        ...
        <div class="border-t pt-6 dark:border-gray-700">
          ...
          <form [formGroup]="shareForm" (ngSubmit)="onSubmit()">
            ...
            <div class="mb-6">
              ...
              <p *ngIf="shareForm.get('sharedWithEmail')?.invalid && shareForm.get('sharedWithEmail')?.touched" class="text-red-500 text-sm mt-1">Please enter a valid email</p>
            </div>
            ...
            <div class="mb-6">
              ...
              <div class="space-y-2">
                <label *ngFor="let scope of availableScopes" class="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg
            ...
            <div class="flex gap-4">
              <button
                ...
                <span *ngIf="isSubmitting">Creating share...</span>
                <span *ngIf="!isSubmitting">Create Share Link</span>
              </button>
              <button
                type="button"
        ...
        <!-- Success Message -->
        <div *ngIf="createdShare" class="mt-6 p-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          ...
          <div class="space-y-4">
            ...
            <!-- Access Code -->
            <div *ngIf="createdShare.accessCode">
              <label class="block text-sm font-medium text-green-800 dark:text-green-200 mb-2">
                Access Code
              </label>
            ...
            <!-- QR Code -->
            <div *ngIf="createdShare.qrCodeDataUrl">
              <label class="block text-sm font-medium text-green-800 dark:text-green-200 mb-2">
                QR Code
              </label>
