        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-white/10">
            <div>
               <h1 class="text-3xl font-bold text-white tracking-tight flex items-center gap-3">
                 <span class="p-2 rounded-lg bg-slate-500/20 text-slate-300">
               ...
               <p class="text-slate-400 text-sm mt-1 ml-12">Manage system-wide settings and configurations</p>
            </div>
            <button
              (click)="saveSettings()"
              class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-all shadow-lg flex items-center gap-2">
